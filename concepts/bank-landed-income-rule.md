...
3. **74200 Miscellaneous income (Other Income): −$245,770 net in 2026**, recurring −$50–82k/month Feb–Jun, from invoice-side documents (credit memos / item lines — invisible to the account-detail endpoint, which scans AccountRef lines only). Moves no cash, so the app's numbers are unaffected (any real cost shows up later as lower bank-landed payments). WHAT IT IS is unknown — Chris to inspect the 74200 register in QBO. One-off oddity also flagged: a $2,000 Bill (SLCC, 2026-03-30, txn 55672) coded to 40100 Retail Sales — books-only miscode.
