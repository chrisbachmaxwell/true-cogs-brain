...
| Federal W/H Tax Payable `21002` | Runs negative (−$295k by 2026-08); contains Jens's PERSONAL IRS payments | $125k of 2026 entries (56368 $58k, 59437 $67k, memo JENS B & ELIZABETH NIE) are personal 1040/1040-ES — cleanup task `jens-personal-taxes-2026` **run 2026-09-11 (both moved to 21005)**. Negative balance predates 2026 → more of the same likely in earlier years |
| Card autopay records 2026 | Categories point at a card instead of the `Credit Cards` wash (99) | 56733/57898/59488 self-coded to AX Purple (no-ops), 58833 Amex autopay coded to AX Purple (+$106k fake Purple growth), 54593 bank payment coded to AX Purple though it paid the Amex. Tasks `card-autopay-credits-2026-*` + row on `card-payments-2025-26-purple` **run 2026-09-11** — the wash leftover (−$123,394.58) went to $0 exactly and AX Purple 2026 growth fell to +$13,053. See log/2026-09-10 |
